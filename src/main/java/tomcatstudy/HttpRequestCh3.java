...
/** this class copies methods from org.apache.catalina.connector.HttpRequestCh3Base
 *  and org.apache.catalina.connector.http.HttpRequestCh3Impl.
 *  The HttpRequestCh3Impl class employs a pool of HttpHeader objects for performance
...
public class HttpRequestCh3 implements HttpServletRequest, Request {
  ...
  public HttpRequestCh3(InputStream input) {
    this.input = input;
  }
